...
def register_engine_core_client():
    EngineCoreClient.release_kv_cache = KvCacheCoreClientMixin.release_kv_cache
    AsyncMPClient.release_kv_cache = KvCacheMPClient.release_kv_cache
    InprocClient.release_kv_cache = KvCacheInprocClient.release_kv_cache
